...
import AddPartForm from "./components/AddPartForm.tsx"
import "./App.css"
...
function App() {
  ...
  const [alerts, setAlerts] = useState<VehiclePart[]>([])
  const [loading, setLoading] = useState(true)
  const [activeTab, setActiveTab] = useState<"inventory" | "alerts" | "add">("inventory")
